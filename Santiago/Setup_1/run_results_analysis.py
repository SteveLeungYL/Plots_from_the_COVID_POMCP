...
for num_of_simulations in range(12, 13, 3):
    
    data_name = "output_num_simulation_{}.csv.process_all.csv".format(
        num_of_simulations
    )
...
legend = ['DOCTOR', 'Random', 'SY', '50-ASY', 'ASY']
...
for cum_I_index in range(len(mean_cum_I_list)):
    ...
    plt.plot(time_step, mean_cum_I, style_list[cum_I_index], linewidth=5.0)
...
plt.legend(legend, handlelength=3)
plt.xlabel(r'Decision points $\bf{d}$', fontsize=35)
plt.ylabel(r'Size of $\bf{I}$', fontsize=35)

plt.tight_layout()

plt.savefig("./Plots/active_I_curve.png", dpi = 400)
plt.close(fig)
...
for S_index in range(len(mean_S_list)):
    ...
    plt.plot(time_step, mean_S, style_list[S_index], linewidth=5.0)
...
plt.legend(legend, handlelength=3)
plt.xlabel(r'Decision points $\bf{d}$', fontsize=35)
plt.ylabel(r'Size of $\bf{S}$', fontsize=35)

plt.tight_layout()


plt.savefig("./Plots/S_curve.png", dpi = 400)
plt.close(fig)
...
for E_index in range(len(mean_E_list)):
    ...
    plt.plot(time_step, mean_E, style_list[E_index], linewidth=5.0)
...
plt.legend(legend, handlelength=3)
plt.xlabel(r'Decision points $\bf{d}$', fontsize=35)
plt.ylabel(r'Size of $\bf{E}$', fontsize=35)

plt.tight_layout()


plt.savefig("./Plots/E_curve.png", dpi = 400)
plt.close(fig)
...
for I1_index in range(len(mean_I1_list)):
    ...
    plt.plot(time_step, mean_I1, style_list[I1_index], linewidth=5.0)
...
plt.legend(legend, handlelength=3)
plt.xlabel(r'Decision points $\bf{d}$', fontsize=35)
plt.ylabel(r'Size of $\bf{I_1}$', fontsize=35)

plt.tight_layout()


plt.savefig("./Plots/I1_curve.png", dpi = 400)
plt.close(fig)
...
for I2_index in range(len(mean_I2_list)):
    ...
    plt.plot(time_step, mean_I2, style_list[I2_index], linewidth=5.0)
...
plt.legend(legend, handlelength=3, ncol = 2)
plt.xlabel(r'Decision points $\bf{d}$', fontsize=35)
plt.ylabel(r'Size of $\bf{I_2}$', fontsize=35)

plt.tight_layout()


plt.savefig("./Plots/I2_curve.png", dpi = 400)
plt.close(fig)
...
for H_index in range(len(mean_H_list)):
    ...
    plot, = plt.plot(time_step, mean_H, style_list[H_index], linewidth=5.0)
...
plt.legend(legend, handlelength=3)
plt.xlabel(r'Decision points $\bf{d}$', fontsize=35)
plt.ylabel(r'Size of $\bf{H}$/$\bf{Q}$', fontsize=35)

plt.tight_layout()


plt.savefig("./Plots/H_Q_curve.png", dpi = 400)
plt.close(fig)
...
for R_index in range(len(mean_R_list)):
    ...
    plt.plot(time_step, mean_R, style_list[R_index], linewidth=5.0)
...
plt.legend(legend, handlelength=3)
plt.xlabel(r'Decision points $\bf{d}$', fontsize=35)
plt.ylabel(r'Size of $\bf{R}$', fontsize=35)

plt.tight_layout()


plt.savefig("./Plots/R_curve.png", dpi = 400)
plt.close(fig)
...
plt.bar(x, mean_asymptomatic_testing_list[0][1:], label='ASY Testing')
plt.bar(x, mean_symptomatic_testing_list[0][1:], bottom= mean_asymptomatic_testing_list[0][1:], label='SY Testing')
plt.legend(loc=4)


y_upper_error = [ x-y for x,y in zip(upper_asymptomatic_testing_list[0][1:], mean_asymptomatic_testing_list[0][1:])]
ax.errorbar(x, mean_asymptomatic_testing_list[0][1:], yerr = y_upper_error, color = "k", capsize=3, fmt=".", ms = 0.0001)

plt.gca().xaxis.set_major_locator(mticker.MultipleLocator(2))

plt.xlabel(r'Decision points $\bf{d}$', fontsize=35)
plt.ylabel("DOCTOR's Action", fontsize=35)
