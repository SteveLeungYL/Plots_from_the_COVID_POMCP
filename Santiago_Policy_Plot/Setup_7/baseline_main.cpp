...
int main() {
    ...
    SEIRoutputfile << "S,E,I1,I2,H,R,cum_I,Run_Count,total_population,R0_value,initial_I_ratio,total_testing_number,asymptomatic_rate,testing_sensitivity" << endl;
...
//    for (int I_class_ratio_index = 0; I_class_ratio_index < 4; I_class_ratio_index++) {
    for (testing_sensitivity = 0.6; testing_sensitivity < 1.0; testing_sensitivity += 0.1) {
...
//                int asymptomatic_testing_number = 0;
                ...
                SEIRoutputfile << S << ", " << E << ", " << I1 << ", " << I2 << ", " << H << ", " << R << ", "
                               ...
                               << total_testing_number << ", " << asymptomatic_rate << ", " << testing_sensitivity
                               << endl;
            }
