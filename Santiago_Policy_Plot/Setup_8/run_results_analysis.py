...
#     for group_number in [5, 16, 32, 64]:
...
for i in range(len(mean_asymptomatic_testing_list)):
    mean_sum_asymptomatic_testing_list.append(sum(mean_asymptomatic_testing_list[i][1:]))
    mean_sum_symptomatic_testing_list.append(sum(mean_symptomatic_testing_list[i][1:]))

    upper_sum_asymptomatic_testing_list.append(sum(upper_asymptomatic_testing_list[i][1:]))
    upper_sum_symptomatic_testing_list.append(sum(upper_symptomatic_testing_list[i][1:]))
