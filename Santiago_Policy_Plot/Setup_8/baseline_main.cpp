...
int main() {
    ...
    SEIRoutputfile << "S,E,I1,I2,H,R,cum_I,Run_Count,total_population,R0_value,initial_I_ratio,total_testing_number,asymptomatic_rate,testing_sensitivity,group_number" << endl;

//    double I_class_ratio_array[4] = {0.0001, 0.0005, 0.005, 0.05};
//    int total_population_list[4] = {10000, 40000, 60000, 90000};
    int group_number_array[5] = {5, 10, 16, 32, 64};
//    for (int I_class_ratio_index = 0; I_class_ratio_index < 4; I_class_ratio_index++) {
    for (int group_number_index = 0; group_number_index < 5; group_number_index++) {
...
//        total_testing_number = int((double)total_population * 0.004);
        ...
        testing_group_number = group_number_array[group_number_index];
        random_device rd;
        mt19937_64 gen(rd());
...
//                int asymptomatic_testing_number = 0;
                ...
                SEIRoutputfile << S << ", " << E << ", " << I1 << ", " << I2 << ", " << H << ", " << R << ", "
                               ...
                               << total_testing_number << ", " << asymptomatic_rate << ", " << testing_sensitivity << ", " << testing_group_number
                               << endl;
            }
