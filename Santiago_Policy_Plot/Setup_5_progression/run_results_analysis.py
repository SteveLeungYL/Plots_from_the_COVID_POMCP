...
for total_testing_number in [400]:
...
for fix_testing_number in [-1, 0, 100, 200]:
    ...
    for total_testing_number in [400]:
        ...
        for run_count in range(sample_total_run_count):
            ...
            current_sample_data = current_sample_data[current_sample_data['total_testing_number'] == total_testing_number]
...
legend = ['POMCP. Sim: $2^{10}$', 'Random_Action', 'Pure Symp', 'Half Public, Half Symp', 'Pure Public']
...
x = list(range(len(mean_asymptomatic_testing_list[0][1:])))

plt.bar(x, mean_asymptomatic_testing_list[0][1:], label='Public Testing Number')
plt.bar(x, mean_symptomatic_testing_list[0][1:], bottom= mean_asymptomatic_testing_list[0][1:], label='Symptomatic Testing Number')
plt.legend(loc=4)
