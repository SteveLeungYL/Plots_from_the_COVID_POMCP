...
for num_of_population in num_of_population_list:
    ...
    for sample_run_count in range(sample_total_run_count):
        ...
        asymptomatic_testing = testing_types
        asymptomatic_testing_current.append(asymptomatic_testing)
        symptomatic_testing_current.append([1.0 - x for x in asymptomatic_testing])
    ...
    mean_asymptomatic_testing_curve = sum(mean_asymptomatic_testing_curve) / len(mean_asymptomatic_testing_curve)
    upper_asymptomatic_testing_curve = sum(upper_asymptomatic_testing_curve) / len(upper_asymptomatic_testing_curve)

    mean_symptomatic_testing_curve = sum(mean_symptomatic_testing_curve) / len(mean_symptomatic_testing_curve)
    upper_symptomatic_testing_curve = sum(upper_symptomatic_testing_curve) / len(upper_symptomatic_testing_curve)
...
for fix_testing_number in [-1, 0, 100, 200]:
    ...
    for total_population in num_of_population_list:
...
xlabel = ["50000", "100000", "150000", "200000"]
...
# x = [i + width for i in x]
# plt.bar(x, mean_peak_H_list[4:8], width=width, label='Random', tick_label = xlabel)
...
sum_mean_asymptomatic_testing_list = [x * 100 for x in mean_asymptomatic_testing_list]
