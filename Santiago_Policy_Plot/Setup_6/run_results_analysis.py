...
for asymptomatic_rate in [0.1, 0.3, 0.5, 0.7]:
    
    data_name = "output_asymptomatic_rate_{:.2f}.csv.process_all.csv".format(
        asymptomatic_rate
    )
...
#             current_sample_data = current_sample_data[current_sample_data['asymptomatic_rate'] == asymptomatic_rate]
